...
[Visual Studio Code](https://code.visualstudio.com) is a distribution of the `Code - OSS` repository with Microsoft specific customizations released under a traditional [Apple product license](https://code.visualstudio.com/License/).
...
Copyright (c) Mizan-Al-Sabbih. All rights reserved.
